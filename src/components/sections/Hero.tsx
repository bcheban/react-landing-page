...
export const Hero = () => {
    ...
    <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3x bg-primary blur-xl opacity-80"></span>
        </div>

        <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start lg:max-w-non max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
